...
# Commitish is 3.0.2 plus relevant hotfix
    git clone https://github.com/MRtrix3/mrtrix3.git && cd mrtrix3 && git checkout 4ab54489f40997f7da1e1915c2adde3373cf6039 && python3 configure -nogui && python3 build -persistent -nopaginate && git describe --tags > /mrtrix3_version && rm -rf .git/ cmd/ core/ src/ testing/ tmp/ && cd ..
